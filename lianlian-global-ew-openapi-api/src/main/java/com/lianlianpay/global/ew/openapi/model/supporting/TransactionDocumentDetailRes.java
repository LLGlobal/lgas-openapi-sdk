 ...
 */
@Data
public class TransactionDocumentDetailRes implements Serializable {
    ...
    /**
     * The left amount of quota, main currency unit, rounded up to 2 decimal places.
     */
    private String availableQuota;

    /**
     * Usage amount of quota, main currency unit, rounded up to 2 decimal places.
     */
